    ...
    */
    ...
    func getSupportedCoinTokenList(){
        ...
        DispatchQueue.global(qos: .default).async {
            ...
            if Setting.shared.forLibraOnlyFlag{
                CoinTokenAccount.serverSupportedCoinAndTokenArray.removeAll()
                CoinTokenAccount.serverSupportedCoinAndTokenArray.append(("LBR", "LBR"))
                self.hideProgress()
                
                DispatchQueue.main.async {
                    self.theRegisterView.coinTokenSelView.setup(coin: "LBR", token: "LBR")
